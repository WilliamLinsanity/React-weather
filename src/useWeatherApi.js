...
const useWeatherApi = (currentLocation) => {
  ...
  const handleCurrentWather = (locationName) => {
    const weatherUrl = `https://opendata.cwb.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=CWB-88D06302-5081-4A40-BD5D-2CCD4CDBEDF4&locationName=${locationName}`;
  ...
  const handleForcastWather = (cityName) => {
    const forecastUrl = `https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWB-88D06302-5081-4A40-BD5D-2CCD4CDBEDF4&locationName=${cityName}`;
